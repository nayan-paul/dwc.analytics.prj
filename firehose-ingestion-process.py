...
def sendData2Firehose():
	try:
		client = boto3.client('firehose',aws_access_key_id='AKIAIAQGX35RKECZZCPA',aws_secret_access_key='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',region_name='us-east-1')
